...
/**
 * E2E tests for the {@code <debate-feed>} panel.
 *
...
class DebatePanelE2ETest {
    ...
    void placeholder_whenNoDebateSession() {
        ...
        assertThat(page.locator("debate-feed .placeholder")).containsText("No entries yet");
    }
    ...
    void roundDivider_appearsOnFirstEntry() {
        ...
        assertThat(page.locator("debate-feed .round-divider")).containsText("Round 1");
    }
    ...
    void raiseEntry_rendersWithCorrectStructure() {
        ...
        assertThat(page.locator("debate-feed .entry-raise")).hasCount(1);
        assertThat(page.locator("debate-feed .badge-priority-high")).hasCount(1);
        assertThat(page.locator("debate-feed .badge-scope")).containsText("ISOLATED");
        assertThat(page.locator("debate-feed .badge-location")).containsText("§3.2");
        assertThat(page.locator("debate-feed .entry-agent")).containsText("Reviewer");
    }
    ...
    void agreeEntry_hasCorrectClass() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-agree").count());
    }
    ...
    void counterEntry_hasCorrectClass() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-counter").count());
    }
    ...
    void disputeEntry_hasCorrectClass() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-dispute").count());
    }
    ...
    void qualifyEntry_hasCorrectClass() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-qualify").count());
    }
    ...
    void declinedEntry_hasReducedOpacity() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-declined").count());
    }
    ...
    void flagHumanEntry_rendersWarningBanner() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-flag_human").count());

        // Assert ::before pseudo-element content
        Object beforeContent = page.evaluate("() => {"
                + "const el = document.querySelector('debate-feed')"
    ...
    void memoEntry_rendersWithMemoClass() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-memo").count());
    }
    ...
    void restartContext_rendersCenteredBranchMarker() {
        ...
        assertThat(page.locator("debate-feed .entry-restart_context")).hasCount(1);
        assertThat(page.locator("debate-feed .entry-restart_context")).containsText("session branched");
    }
    ...
    void multipleRounds_showsSeparateDividers() {
        ...
        assertThat(page.locator("debate-feed .round-divider")).hasCount(2);
        assertThat(page.locator("debate-feed .round-divider").nth(0)).containsText("Round 1");
        assertThat(page.locator("debate-feed .round-divider").nth(1)).containsText("Round 2");
    }
    ...
    void subTaskRequest_rendersIndented() {
        ...
        assertEquals(1, page.locator("debate-feed .entry-sub_task_request").count());
    }
    ...
    void subTaskFinding_rendersWithPointBadge() {
        ...
        try {
            page.locator("debate-feed .entry-sub_task_finding")
                    .waitFor(new com.microsoft.playwright.Locator.WaitForOptions().setTimeout(5000));
            assertEquals(1, page.locator("debate-feed .entry-sub_task_finding").count());
    ...
    void subTaskError_rendersWithErrorStyling() {
        ...
        // TODO: Re-enable full assertion once casehub-ledger TENANCY_ID migration is applied.
        try {
            page.locator("debate-feed .entry-sub_task_error")
                    .waitFor(new com.microsoft.playwright.Locator.WaitForOptions().setTimeout(5000));
            assertEquals(1, page.locator("debate-feed .entry-sub_task_error").count());
            assertThat(page.locator("debate-feed .entry-sub_task_error")).containsText("No handler matched");
        } catch (com.microsoft.playwright.TimeoutError e) {
            org.junit.jupiter.api.Assumptions.assumeTrue(false,
                    "Ledger TENANCY_ID drift prevents async fan-out — skipping");
        }
