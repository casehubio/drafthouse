...
Quarkus Server (drafthouse-server-runner.jar)
  ...
  ├── MCP tools (debate)     ← start_debate (optional autonomous=true), raise_point, respond_to, flag_human, get_debate_summary, end_debate, report_context
